FILES = ./build/kernel.asm.o ./build/isr80h/isr80h_io.o ./build/isr80h/process.o ./build/keyboard/keyboard.o ./build/isr80h/heap.o ./build/keyboard/classic.o ./build/kernel.o ./build/task/tss.asm.o ./build/loader/formats/elf.o ./build/gdt/gdt.asm.o ./build/loader/formats/elfloader.o ./build/isr80h/isr80h.o ./build/task/task.o ./build/idt/idt.asm.o ./build/fs/fat/fat16.o ./build/gdt/gdt.o ./build/disk/disk.o ./build/fs/file.o ./build/disk/diskstreamer.o ./build/fs/pparser.o ./build/string/string.o ./build/idt/idt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/task/process.o ./build/task/task.asm.o

INCLUDES = -I./src
FLAGS = -g -ffreestanding -falign-jumps -falign-functions -falign-labels -falign-loops -fstrength-reduce -fomit-frame-pointer -finline-functions -Wno-unused-function -fno-builtin -Werror -Wno-unused -Wno-unused-label -Wno-cpp -Wno-unused-parameter -nostdlib -nodefaultlibs -Wall -O0 -Iinc
...
./build/isr80h/isr80h_io.o: ./src/isr80h/isr80h_io.c
	i686-elf-gcc $(INCLUDES) -I./src/isr80h $(FLAGS) -std=gnu99 -c ./src/isr80h/isr80h_io.c -o ./build/isr80h/isr80h_io.o
...
./build/disk/diskstreamer.o: ./src/disk/diskstreamer.c
	i686-elf-gcc $(INCLUDES) -I./src/disk $(FLAGS) -std=gnu99 -c ./src/disk/diskstreamer.c -o ./build/disk/diskstreamer.o
